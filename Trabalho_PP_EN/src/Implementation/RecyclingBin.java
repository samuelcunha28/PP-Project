...
public class RecyclingBin implements IRecyclingBin {
    ...
    public RecyclingBin(String code, String zone, String description, String type, IGeographicCoordinates geographicCoordinates) {
        ...
        this.containers = new IContainer[CONTAINER_SIZE];
        this.paths = new IPath[PATH_SIZE];
    }
    
    /**
     * POSSIVELMENTE ELIMINAR ESTE CONSTRUTOR
     * Constructor of Recycling Bin
     * @param code the recycling bin code
     * @param zone the recycling bin zone
     * @param description the recycling bin description of the place
     ...
     */
    public RecyclingBin(String code, String zone, String description, String type, IPath distance, IPath duration, IGeographicCoordinates geographicCoordinates, Container[] containers, Path[] paths) {
        this.code = code;
        this.zone = zone;
        this.description = description;
        this.type = type;
    ...
    /**
     * Getter for the description of the place in which the recycling bin is installed
    ...
    /**
     * Setter for the description of the place in which the recycling bin is installed
    ...
    /**
     * Getter for Distance and Duration between current recycling bin and parameter irb
     ...
     * @return true if the container was inserted in the collection storing all containers;
     * False if the container already exists
     * @throws ContainerException if container is null; container type (waste type) already exists
     */
    @Override
    ...
    /**
     * Adds a new path describing the path between this recycling bin to other recycling bin
     * @param ipath the path
     * @return true if the path was inserted in the collection storing all paths;
    ...
    public boolean addPath(IPath ipath) throws RecyclingBinException {
        boolean duplicated = false;
        Path[] temp = new Path[this.paths.length + 1];
